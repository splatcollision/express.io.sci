...
# console.log 18
# session = express.session # was getting old vars from session into new
...
express.application.io = (options) ->
    # todo fix to return correct this
    options ?= new Object
    ...
    @io.use (data, next) =>
        ...
        # express.application.use(session({ secret: 'keyboard cat', cookie: { maxAge: 60000 }}))
        # cookieParser = express.cookieParser()
        cookieParserInst data, null, (error) ->
            return next error if error?
